...
static sw_tuple_handler_t *global_tuple_handlers[] = {
  &ip_nat_tuple_handler,
  &tcp_tuple_handler,
  &udp_tuple_handler,
  &icmp_nat_tuple_handler,
  NULL
};

uint32_t sw_nat_tuple_hash(sw_tuple_t *tuple_chain) {
  int idx;
...
int sw_nat_tuple_cmp(sw_tuple_t *tuple_chain_a, sw_tuple_t *tuple_chain_b) {
  int idx;
